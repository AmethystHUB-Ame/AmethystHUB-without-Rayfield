...
sidebar.Size = UDim2.new(0, sidebarWidth, 1, -56) -- top bar 36 + status bar 20
...
statusLeft.Size = UDim2.new(0.33, 0, 1, 0)
...
statusCenter.Size = UDim2.new(0.34, 0, 1, 0)
statusCenter.Position = UDim2.new(0.33, 0, 0, 0)
...
statusCenter.ZIndex = 5
statusCenter.Parent = statusBar

local statusRight = Instance.new("TextLabel")
statusRight.Name = "StatusRight"
statusRight.Size = UDim2.new(0.33, -8, 1, 0)
statusRight.Position = UDim2.new(0.67, 0, 0, 0)
...
task.spawn(function()
    while true do
        ...
        _safeCall(function()
            statusCenter.Text = "FPS: " .. tostring(_fpsValue) .. " | Ping: " .. pingVal .. "ms"
        end)
    end
end)
...
-- Semi-transparent pill in the top-right corner showing "Amethyst V4 | FPS | Ping"
...
wmPill.Position = UDim2.new(1, -260, 0, 10) -- top-right, 10px margin
